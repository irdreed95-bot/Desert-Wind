      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            <a href="https://wa.me/9647800000000" target="_blank" rel="noreferrer" className="text-[#25D366] hover:scale-110 transition-transform" data-testid="link-whatsapp">
              <SiWhatsapp size={20} />
            </a>
            <a href="https://instagram.com/_x1om_" target="_blank" rel="noreferrer" className="text-[#E1306C] hover:scale-110 transition-transform" data-testid="link-instagram">
              <SiInstagram size={20} />
            </a>
            <a href="https://t.me/whitewolfiq" target="_blank" rel="noreferrer" className="text-[#26A5E4] hover:scale-110 transition-transform" data-testid="link-telegram">
              <SiTelegram size={20} />
            </a>
            <a href="https://facebook.com/whitewolfiq" target="_blank" rel="noreferrer" className="text-[#1877F2] hover:scale-110 transition-transform" data-testid="link-facebook">
              <SiFacebook size={20} />
            </a>
            <a href="https://youtube.com/@whitewolfiq" target="_blank" rel="noreferrer" className="text-[#FF0000] hover:scale-110 transition-transform hidden md:block" data-testid="link-youtube">
              <SiYoutube size={20} />
            </a>
          </div>
